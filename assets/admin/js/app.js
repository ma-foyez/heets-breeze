        ...
        document.getElementById("header-lang-img") &&
            ("en" == e
                ? (document.getElementById("header-lang-img").src =
                      "{{ asset('') }}assets/images/flags/us.jpg")
                : "sp" == e
                ? (document.getElementById("header-lang-img").src =
                      "{{ asset('') }}assets/images/flags/spain.jpg")
                : "gr" == e
                ? (document.getElementById("header-lang-img").src =
                      "{{ asset('') }}assets/images/flags/germany.jpg")
                : "it" == e
                ? (document.getElementById("header-lang-img").src =
                      "{{ asset('') }}assets/images/flags/italy.jpg")
                : "ru" == e &&
                  (document.getElementById("header-lang-img").src =
                      "{{ asset('') }}assets/images/flags/russia.jpg"),
            localStorage.setItem("language", e),
            null == (t = localStorage.getItem("language")) && n(s),
            a.getJSON(
                "{{ asset('') }}assets/lang/" + t + ".json",
                function (e) {
                    a("html").attr("lang", t),
    ...
    function r(e) {
        ...
        "light-mode-switch" === e
            ...
            ? (a("#light-mode-switch").prop("checked", !1),
              ...
              a("#bootstrap-style").attr(
                  "href",
                  "{{ asset('') }}assets/css/bootstrap-rtl.min.css"
              ),
              a("#app-style").attr(
                  "href",
                  "{{ asset('') }}assets/css/app-rtl.min.css"
              ),
              a("html").attr("dir", "rtl"),
              a("body").attr("data-layout-mode", "light"),
